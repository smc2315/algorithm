...
class Solution {
    public int[] solution(int n, int[][] paths, int[] gates, int[] summits) {
        ...
        int[] intensities = dijkstra(n, graph, gates, gateMap, summitMap);
    ...
    private int[] dijkstra(int n, ArrayList<ArrayList<Node>> graph, int[]gates, HashMap<Integer, Boolean> summitMap, HashMap<Integer, Boolean> gateMap) {
